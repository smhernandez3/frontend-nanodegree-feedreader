$(function() {
    ...
    describe('The Menu', function(){
        ...
        //I know the code below looks strange, but when I assigned the variable
        // var body = document.body.className it was being assigned to "menu-hidden"
        // and not the acual body object.
        className = className;
